...
| [**dj-rest-auth**](https://github.com/iMerica/dj-rest-auth) | API endpoints for login, registration, and password reset (drop-in replacement for django-rest-auth). | Endpoints de API para login, registro e redefinição de senha. |
...
| [**Django Vite**](https://github.com/MrBin99/django-vite) | Integration for ViteJS in Django applications. | Integração para ViteJS em aplicações Django. |

## 🗄 Database, Models & Files / Banco de Dados, Models e Arquivos
